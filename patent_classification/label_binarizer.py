...
def get_multitask_output(y):
    """
    Get Multitask Output.

    Args:
        y (numpy): binarized value. 

    Returns:
        numpy: multitask output
    """
    y_multitask = list()
...
def get_mlb_output(y):
    """
    MutliLabel Binarizer Output.

    Args:
        y (numpy): multitask binarized values

    Returns:
        numpy: MultiLabelBinarized values
    """
    y_bin = list()
...
#     Args:
#         y (numpy): _description_
#         y_pred (numpy): _description_
